...
customApp.controller('dashboardMainController', ['$scope', '$route', '$http', 'DTOptionsBuilder', 'DTColumnBuilder', '$compile', '$filter', '$timeout', function($scope, $route, $http, DTOptionsBuilder, DTColumnBuilder, $compile, $filter, $timeout) {
    var vm = this;
